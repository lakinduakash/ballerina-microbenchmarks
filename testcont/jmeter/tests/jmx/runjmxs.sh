...
/usr/share/apache-jmeter-5.2.1/bin/jmeter --forceDeleteResultFile -n -t /usr/tests/jmx/Test_Plan_File.jmx -Jthreads=1 -Jduration=1800 -Jramp_time=3 -l results_file_1.jtl -e -o "reports_file_1"
/usr/share/apache-jmeter-5.2.1/bin/jmeter --forceDeleteResultFile -n -t /usr/tests/jmx/Test_Plan_CPU.jmx -Jthreads=1 -Jduration=1800 -Jramp_time=3 -l results_cpu_1.jtl -e -o "reports_cpu_1"
/usr/share/apache-jmeter-5.2.1/bin/jmeter --forceDeleteResultFile -n -t /usr/tests/jmx/Test_Plan_Memory.jmx -Jthreads=1 -Jduration=1800 -Jramp_time=3 -l results_memory_1.jtl -e -o "reports_memory_1"
#/usr/share/apache-jmeter-5.2.1/bin/jmeter --forceDeleteResultFile -n -t /usr/tests/jmx/Test_Plan_IO_5.jmx -Jthreads=1 -Jduration=1800 -Jramp_time=3 -l results_io_1.jtl -e -o "reports_io_1"
echo "#########################"
